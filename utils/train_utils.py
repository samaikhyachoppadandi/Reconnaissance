...
train_wkt_v4 = pd.read_csv('C:/Users/Sam/PycharmProjects/DSTL_UNET/dstl/train_wkt_v4.csv')
grid_sizes = pd.read_csv('C:/Users/Sam/PycharmProjects/DSTL_UNET/dstl/grid_sizes.csv', skiprows = 1, names = ['ImageId', 'Xmax', 'Ymin'])
x_crop = 3345
y_crop = 3338
